...
import MaxWidthWrapper from "@/components/MainWidthWrapper";
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg-pt-4">
            ...
            >
              ...
              font-bold !leading-tight text-grey-900 text-5xl md:text-6xl lg:text-7xl"
              >
                Your Image on a{" "}
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            font-bold text-5xl md:text-6xl text-grey-900"
            >
              What our{" "}
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grod-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keepo my phone together with my keys in my pocket
                  and that led to some pretty heavy scratchmarks on all of my
                  last phone cases. This one, besides a barely noticable scratch
                  on the corner,{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    looks brand new after about 6 months
                  </span>
                  . I dig it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Caleb McDaniel</p>
                  <div className="flex gap-1.5 items center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
